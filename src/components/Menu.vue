    ...
    <ul class="menu">
      ...
      <li class="menu__top">
        <router-link to="/" class="menu__logo">
          <img src="../assets/a.jpg" alt="icon" width="50" height="50">
        </router-link>
        <a
        href="#"
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('blockImage')" :class="highlightSection('blockImage')"
        >
...
export default {
  ...
  methods: {
    ...
    updateMenu (context) {
      ...
      } else if (context === 'blockImage') {
        this.$router.push('/blockImage')
        window.bus.$emit('menu/closeMobileMenu')
      }
    },
